...
int main(void)
{
        ...
        CHECK(gnutls_server_name_set(session, GNUTLS_NAME_DNS, "nhs_server_domain.com",
                                     strlen("nhs_server_domain.com")));
        ...
        gnutls_session_set_verify_cert(session, "nhs_server_domain.com", 0);
	...
	CHECK(gnutls_record_send(session, "quit", 4));
